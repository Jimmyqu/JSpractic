...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                exportBtnShow:this.getCurrentUserAuthority("mileageOil/mileageExcel"),
                listUrl:"report/mileageOil/mileageDetailList",
                dialogForm:{},
                searchParam: {},
                tableHeader:[]
            }
        ...
        methods: {
            ...
            exportExcel(){
                window.location = this.exportUrl("report/mileageOil/mileageExcel?" + $.param(this.getListParam()));
            },getListParam(){
