        ...
        <div class="content">
            <div class="left-box">
                <div class="box1 box-common">
                    <div class="title" v-if="getCurrentUserAuthority('base/workbench/vehicleServiceStatistics')">车辆服役状态</div>
                    <div class="chart-list hide-scrollbar" v-if="getCurrentUserAuthority('base/workbench/vehicleServiceStatistics')">
                    ...
                    <div class="no-data no-data-bj hide-scrollbar" v-if="!getCurrentUserAuthority('base/workbench/vehicleServiceStatistics')">
                        <div class="plate"></div>
            ...
            <div class="middle-box" :class="{'middle-box-hide':!getCurrentUserAuthority('base/workbench/contractQuantityStatistics')}">
                ...
                <div class="box-common-border middle-box-2">
                    <div class="box3 box-common">
                        ...
                        <div class="remind-box hide-scrollbar" v-if="getCurrentUserAuthority('base/workbench/alert')">
                            <div class="item">
                            ...
                            <div class="item">
                                <num-change :value="alertData.backOutNum" type="1"
                                            @click.native="toDetail('/tgpt_v2/se/backout?dealStatus=1')"></num-change>
                                <div>拆机</div>
                            </div>
                            <div class="item">
                            ...
                            <div class="item">
                                <num-change :value="alertData.passValidNum" type="1"
                                            @click.native="toDetail('/tgpt_v2/base/passValid?dealStatus=0')"></num-change>
                                <div>通行证到期</div>
                            </div>
                            <div class="item">
                ...
                <div class="box-common-border" style="height: 30%;margin-top: 15px" v-if="getCurrentUserAuthority('base/workbench/contractQuantityStatistics')">
                    <div class="box4 box-common">
                        <div class="title" >合同数量统计</div>
            ...
            <div class="right-box box-common-border">
                <div class="box-common">
                    <div class=" box5 hide-scrollbar" v-if="getCurrentUserAuthority('base/workbench/financialAccount') || getCurrentUserAuthority('base/workbench/contractCurrentStatus')
                        || getCurrentUserAuthority('base/workbench/trafficStatistics') || getCurrentUserAuthority('base/workbench/purchaseDisposalVehicleStatistics')">
                        <div class="title" v-if="getCurrentUserAuthority('base/workbench/financialAccount')">财务账款</div>
                        <div class="small-box small-box1" v-if="getCurrentUserAuthority('base/workbench/financialAccount')">
                            <div class="item">
                                <div class="info">
                                    <span>本月应收</span>
                        ...
                        <div class="line" v-if="getCurrentUserAuthority('base/workbench/contractCurrentStatus') && getCurrentUserAuthority('base/workbench/financialAccount')"></div>
                        ...
                        <div class="line" v-if="getCurrentUserAuthority('base/workbench/trafficStatistics') && (getCurrentUserAuthority('base/workbench/contractCurrentStatus')||
                        getCurrentUserAuthority('base/workbench/financialAccount'))"></div>
                        <div class="title" v-if="getCurrentUserAuthority('base/workbench/trafficStatistics')">本月车务统计</div>
                        <div class="list" v-if="getCurrentUserAuthority('base/workbench/trafficStatistics')">
                        ...
                        <div class="line" v-if="getCurrentUserAuthority('base/workbench/purchaseDisposalVehicleStatistics') && (getCurrentUserAuthority('base/workbench/trafficStatistics')||
                        getCurrentUserAuthority('base/workbench/contractCurrentStatus') || getCurrentUserAuthority('base/workbench/financialAccount'))"></div>
                    ...
                    <div class="no-data" v-if="!getCurrentUserAuthority('base/workbench/financialAccount') && !getCurrentUserAuthority('base/workbench/contractCurrentStatus')
                        && !getCurrentUserAuthority('base/workbench/trafficStatistics') && !getCurrentUserAuthority('base/workbench/purchaseDisposalVehicleStatistics')">
