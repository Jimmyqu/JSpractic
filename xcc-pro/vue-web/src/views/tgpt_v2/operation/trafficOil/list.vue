    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        ...
        <div class="table-box">
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading":data="list" style="width: 100%" border>
                ...
                <el-table-column prop="oilNum" sortable label="加油单号" show-overflow-tooltip min-width="140">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="oilTime" sortable label="加油时间" min-width="120"></el-table-column>
                <el-table-column prop="oilArea" sortable label="加油地点" min-width="180"></el-table-column>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                showSearch: false,
                showConfirmBtn:this.getCurrentUserAuthority("oil/confirm"),
        ...
        methods: {
            ...
            detail(row) {
                this.$router.push({path:"/tgpt_v2/operation/trafficOil/detail/"+row.id});
            },
            confirm(row) {
                this.$router.push({path:"/tgpt_v2/operation/trafficOil/confirm/"+row.id});
            },
            changeOrganization(){
