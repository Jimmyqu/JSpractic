    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        ...
        <div class="table-box">
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading"border :data="list" style="width: 100%">
                ...
                <el-table-column min-width="140" label="侧翻角度" prop="angle" sortable show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            exportExcel() {
                ...
                window.location = this.exportUrl("obd//obdAlarmRollover//excel?" + $.param(this.searchParam));
            },
            updateDateChange() {
                if(this.updateDate && this.updateDate.length>0){
                    let updateDate = this.updateDate;
