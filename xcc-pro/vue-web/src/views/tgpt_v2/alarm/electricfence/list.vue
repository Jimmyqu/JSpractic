    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        <div class="search-box" :class="{'hide-search':!showSearch}">
            <div class="form-box">
                ...
                <div class="form-group">
                    <label class="control-label">里程范围</label>
                    <div class="input-group">
                        <el-select v-model="searchParam.violationMileage" clearable placeholder="请选择里程范围">
                            <el-option label="10公里以下" :value="1"></el-option>
                            <el-option label="10公里到30公里" :value="2"></el-option>
                            <el-option label="30公里以上" :value="3"></el-option>
                        </el-select>
                    </div>
                </div>
            ...
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading" border :data="list" style="width: 100%">
                ...
                <el-table-column fixed="left" label="操作" width="150">
                    <template slot-scope="scope">
                        <el-button type="text" @click="detail(scope.row.id)">行驶轨迹</el-button>
				...
				<el-table-column min-width="140" label="开始报警地址" prop="startAddress" sortable show-overflow-tooltip></el-table-column>
				<el-table-column min-width="140" label="结束报警地址" prop="endAddress" sortable show-overflow-tooltip></el-table-column>
				<el-table-column min-width="140" label="违规里程(km)" prop="violationMileage" sortable show-overflow-tooltip></el-table-column>
				<el-table-column min-width="140" label="违规时长" prop="durationTime" sortable show-overflow-tooltip></el-table-column>
        ...
        <el-dialog title="点子围栏处理" :visible.sync="dialogFormVisible">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                exportBtnShow: this.getCurrentUserAuthority("obdAlarmElectricFence/exportExcel"),
                showDealBtn: this.getCurrentUserAuthority("obdAlarmElectricFence/showDealBtn"),
                showSearch: false,
                searchParam: {
                },
                updateDate:[],
                organization:[],
                listUrl: 'obd//obdAlarmElectricFence',
        ...
        mounted() {
            ...
            //this.searchParam.vehicleStatus = this.$route.query.vehicleStatus;
        ...
        methods: {
            ...
            submitForm(form) {
                ...
                this.$refs[form].validate((valid) => {
                    ...
                    ajax.post('obd/obdAlarmElectricFence/deal', data).then(rs => {
                        if (rs.status == 0) {
                            this.$message({
                                message: '操作成功',
                                type: 'success'
            ...
            exportExcel() {
               this.updateDateChange();
                window.location = this.exportUrl("obd//obdAlarmElectricFence//excel?" + $.param(this.searchParam));
            },
            updateDateChange() {
                if(this.updateDate && this.updateDate.length>0){
                    let updateDate = this.updateDate;
