...
<script>
    ...
    export default {
        ...
        ,
        mounted() {
            ajax.get('obd/obdAlarmSeriousCollision/detail/' + this.id,).then(rs => {
            ...
            ajax.get('obd/obdAlarmSeriousCollision/findVehicleStatusByVehicleId/' + this.id).then(rs => {
                ...
                var new_point = new BMap.Point(currentVehicleTrack.olongitude, currentVehicleTrack.olatitude);
