...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            ajax.get('obd/obdAlarmVibration/findVehicleStatusByVehicleId/' + this.id).then(rs => {
                debugger;
                if(rs.data == null){
                ...
                var new_point = new BMap.Point(currentVehicleTrack.vlongitude, currentVehicleTrack.vlatitude);
...
debugger;
                marker.addEventListener("click", function(){
                    ...
                    if (rs.vehicleStatus == 1) {
                        ...
                        status = "离线";
                        content += "<p>状态：" + status +" 航向："+gpsdrct + "</p>";
                        content += "<p>时间：" + currentVehicleTrack.creatTime +"</p>";
