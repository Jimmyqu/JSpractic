<template>
    <div class="detail-panel">
        <el-collapse v-model="activeNames" >
            ...
            <el-collapse-item title="合同明细" name="5">
                <el-table class="left" border :data="projectContractDetailList" style="width: 100%">
                    ...
                    <el-table-column prop="vehicleQty" label="车辆台数（台）" min-width="150">
                        <template slot-scope="scope">
                            <a size="mini" style="color: #409EFF;" @click="openOrderDialog(scope.row.id)" v-if="projectContractModel.existOrder">{{scope.row.vehicleQty}}/{{scope.row.remainVehicleQty}}</a>
                            <div v-else>{{scope.row.vehicleQty}}/{{scope.row.remainVehicleQty}}</div>
                        </template>
                    </el-table-column>
        ...
        <el-dialog title="订单详情" :visible.sync="orderDialog" :append-to-body="true" width="1000px">
            <div class="list-panel">
                ...
                <div class="table-box">
                    <el-table border :data="list">
                        ...
                        <el-table-column property="orderNo" label="订单编号" show-overflow-tooltip min-width="200"></el-table-column>
                        <el-table-column property="orderStatusText" label="订单状态" show-overflow-tooltip min-width="120"></el-table-column>
                        <el-table-column property="plate" label="车辆" show-overflow-tooltip min-width="120"></el-table-column>
                        <el-table-column property="driverName" label="司机" show-overflow-tooltip min-width="80"></el-table-column>
                        <el-table-column property="startDate" label="用车开始时间" show-overflow-tooltip min-width="120"></el-table-column>
                        <el-table-column property="endDate" label="用车结束时间" show-overflow-tooltip min-width="120"></el-table-column>
                        <el-table-column property="finishDate" label="完结时间" show-overflow-tooltip min-width="120"></el-table-column>
                    </el-table>
                    <el-pagination
...
<script>
    ...
    export default {
        ...
        methods: {
            detail:function () {
                ajax.get("core/coreProjectContractExecute/getDetail?id=" + this.id).then(result =>{
            ...
            openOrderDialog(id){
                if(id){
                    this.getListByUrl("core/coreProjectContractExecute/showOrderList?projectContractExecuteDetailId="+id);
