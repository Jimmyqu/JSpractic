<template>
        <el-dialog :visible.sync="show" title="加油单" width="90%"
                   :append-to-body="true">
                        ...
                        <el-table :data="list" style="width: 100%" border>
                            <el-table-column fixed label="操作" width="80">
                                <template slot-scope="scope">
                                    <el-button @click.native.prevent="selectFuelBill(scope.row)" type="text" size="small">
                                        选择
                                    </el-button>
                                </template>
                            </el-table-column>
                            <el-table-column fixed prop="orderNo" sortable label="订单号" min-width="180"></el-table-column>
                            ...
                            <el-table-column prop="addOilTime" sortable label="加油时间" min-width="180"></el-table-column>
                        </el-table>
                        <el-pagination
...
<script>
    ...
    export default {
        name: "fuelBillListPanel",
        mixins: [tool],
        data(){
            return {
                show:false,
                listUrl:"core/vehicleaccident/fuelbilllist",
            }
        },
        methods:{
            open(vehicleId){
