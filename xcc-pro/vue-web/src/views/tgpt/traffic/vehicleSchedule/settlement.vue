                ...
                <el-collapse-item title="服务信息" name="4" >
                    ...
                    <div class="form-panel">
                        ...
                        <el-collapse-item title="费用信息" name="5" >
                            ...
                            <el-collapse-item title="我司承担费用信息" name="6" >
                                <div class="flex-panel">
                                    <el-form-item label="路桥费" prop="myTollCharge">
                                        <money-input v-model="scheduleForm.myTollCharge"  clearable  placeholder="请输入路桥费" unit="元"></money-input>
                                    </el-form-item>
                                    <el-form-item label="停车费" prop="myParkingCharge">
                                        <money-input v-model="scheduleForm.myParkingCharge"  clearable  placeholder="请输入停车费"  unit="元"></money-input>
                                    </el-form-item>
                                    <el-form-item label="加油费" prop="myOilFee">
                                        <money-input v-model="scheduleForm.myOilFee"  clearable  placeholder="请输入加油费"  unit="元"></money-input>
                                    </el-form-item>
                                    <el-form-item label="其他费用说明" prop="myFeeRemark">
                                        <el-input clearable maxlength="50" v-model="scheduleForm.myFeeRemark"  placeholder="请输入其他费用说明"></el-input>
                                    </el-form-item>
                                </div>
                            </el-collapse-item>
                        <div class="left-row">
