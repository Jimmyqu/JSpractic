            ...
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading" border :data="list" style="width: 100%">
                <el-table-column fixed="left" label="操作" width="150">
                    <template slot-scope="scope">
                       ...
                       <!-- <el-button v-show="showDetailBtn" type="text" @click="detailRoute (scope.row.id)">查看行程</el-button>-->
                    </template>
                </el-table-column>
                ...
                <el-table-column min-width="140" label="开始地址" prop="startAddress" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="结束地址" prop="endAddress" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="违规时长" prop="timeduration" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="越界里程(km)" prop="violationMileage" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="驾驶员姓名" prop="driveName" sortable show-overflow-tooltip></el-table-column>

            </el-table>
        </div>

        <el-dialog title="区域栅栏处理" :visible.sync="dialogFormVisible">
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                exportBtnShow: this.getCurrentUserAuthority("obdAlarmAreaLimit/exportExcel"),
                showDealBtn: this.getCurrentUserAuthority("obdAlarmAreaLimit/showDealBtn"),
                showDetailBtn: true,
                showSearch: false,
                organization:[],
                creatDate:[],
        ...
        methods: {
            ...
            submitForm(form) {
                ...
                this.$refs[form].validate((valid) => {
                    ...
                    ajax.post('obd/obdAlarmAreaLimit/deal', data).then(rs => {
                        if (rs.status == 0) {
                            this.$message({
                                message: '操作成功',
                                type: 'success'
            ...
            exportExcel() {
                ...
                window.location = this.exportUrl("obd//obdAlarmAreaLimit//excel?" + $.param(this.searchParam));
            },
            changeOrganization(data){
