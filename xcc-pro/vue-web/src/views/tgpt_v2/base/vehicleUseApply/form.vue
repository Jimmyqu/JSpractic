            ...
            <el-collapse v-model="openCollapse">
                ...
                <el-collapse-item title="使用信息" name="1" >
                    <div class="flex-panel">
                        ...
                        <el-form-item label="申请使用车辆数" prop="vehicleUseAmount">
                            <el-input v-model="addForm.vehicleUseAmount"  clearable disabled></el-input>
                        </el-form-item>

                        <el-form-item label="申请使用说明" prop="useInstructions">
    ...
    export default {
        ...
        methods:{
            saveVehicleData(data){
                ...
                this.$set(this.addForm,"vehicleUseAmount",this.addForm.useApplyDetail.length);
            ...
            deleteItem(scope) {
                ...
                ajax.get("base/baseVehicleUseApply/reductionVehicleStatus/"+scope.row.vehicleId).then(()=>{
                    //this.getList();
                });
            },
            clearValidate(){
            ...
            initForm(id){
                ...
                this.numberlabel = "";
                ajax.get("base/baseVehicleUseApply/edit/"+id).then(res => {
            ...
            submitForm(addForm) {
                ...
                if(data.useApplyDetail.length == 0){
                    this.$message({message: '没有添加使用车辆！',type: 'error'});
                    return;
                }
                this.$refs[addForm].validate((valid) => {
                    if (valid) {
                        var url = "/base/baseVehicleUseApply/saveVehicleDetail";
