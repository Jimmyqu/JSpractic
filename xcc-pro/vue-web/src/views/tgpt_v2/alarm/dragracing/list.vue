    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        ...
        <div class="table-box">
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading" border :data="list" style="width: 100%">
                ...
                <el-table-column min-width="140" label="飙车时长" prop="overSpeedTimeDuration" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="飙车里程(km)" prop="mileage" sortable show-overflow-tooltip></el-table-column>
                ...
                <el-table-column min-width="140" label="驾驶员" prop="driveName" sortable show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listUrl: 'obd//obdAlarmDragracing'
            }
        },
        activated(){
            this.getList();
        ...
        methods: {
            ...
            exportExcel() {
                ...
                window.location = this.exportUrl("obd//obdAlarmDragracing//excel?" + $.param(this.searchParam));
            },
