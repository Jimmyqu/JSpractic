<template>
    <el-dialog :title="relatioTitle" :visible.sync="show" width="1000px"
        ...
        <el-tree v-loading="showTreeLoading" :data="treeData" ref="tree" show-checkbox node-key="id" default-expand-all
    ...
    export default {
        ...
        methods: {
            ...
            treeInit(roleId) {
                ...
                this.treeData = [];
                ajax.get("admin/role/customerAdminMenuPermission/" + roleId).then(res => {
            ...
            save() { //修改权限
                ...
                ajax.post("admin/role/saveCustomerAdminMenuPermission", data)
                    .then((res) => {
