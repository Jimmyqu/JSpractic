    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        ...
        <div class="content" v-loading="listLoading">
                    ...
                    <div class="table-box">
                        <div class="table-content">
                            <el-table :ref="getRefName" :max-height="tableHeight" border :data="list" style="width: 100%" show-summary>
                                ...
                                <el-table-column prop="count" sortable label="保养总次数" min-width="100"></el-table-column>
                                <el-table-column prop="totalPrice" sortable label="保养总金额(元)" min-width="120"></el-table-column>
            ...
            <div class="content-right">
                <p class="register">保养总金额：<span class="text-green">{{totalPrice}} 元</span></p>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listUrl: 'report/maintenanceReportController/byVehicleList',
                excelUrl: 'report/maintenanceReportController/excel',
                showExportExcelBtn: this.getCurrentUserAuthority('maintenanceReportController/exportExcel'),
                showSearch: false,
                carUseMonth: [],
                originateDeptId: [],
                totalPrice: 0
        ...
        methods: {
            ...
            handleClick(){
                if(this.activeName == "2"){
                    this.listUrl = 'report/maintenanceReportController/byServiceList';
                }else {
                    this.listUrl = 'report/maintenanceReportController/byVehicleList';
                }
                this.getList();
            },
            toDetail(plate, regionId){
                ...
                this.$router.push({path:url + "&type=2"});
            },
            ...
            exportExcel(){
                debugger
                if(this.activeName == "2"){
                    this.excelUrl = 'report/maintenanceReportController/excelService?';
                }else {
                    this.excelUrl = 'report/maintenanceReportController/excel?';
                }
            ...
            getFuelConsumption() {
                ...
                ajax.get('report/maintenanceReportController/getChartData', $this.searchParam).then(res => {
                    if(res.status == 0){
                        let data = {
                            date:[],
                            money:[],
