    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        ...
        <div class="content" v-loading="listLoading">
                    ...
                    <div class="table-box">
                        <div class="table-content">
                            <el-table  :ref="getRefName" :max-height="tableHeight"  border :data="list" style="width: 100%" show-summary>
                                ...
                                <el-table-column prop="oilCost" sortable label="维修总金额(元)" min-width="120"></el-table-column>
                                <el-table-column prop="partsCost" sortable label="配件费用(元)" min-width="120"></el-table-column>
                                <el-table-column prop="workCost" sortable label="工时费用(元)" min-width="120"></el-table-column>
            ...
            <div class="content-right">
                <p>维修总金额：<span class="text-red">{{oilCost}} 元</span></p>
    ...
    export default {
        ...
        data() {
            return {
                activeName: "1",
                mChart2:null,
                listUrl: 'report/repairCwReport/byVehicleList',
                excelUrl: 'report/repairCwReport/excel',
                showExportExcelBtn: this.getCurrentUserAuthority('repairCwReport/exportExcel'),
                showSearch: false,
                carUseMonth: [],
                originateDeptId: [],
                oilCost: 0,
        ...
        methods: {
            ...
            handleClick(){
                if(this.activeName == "2"){
                    this.listUrl = 'report/repairCwReport/byServiceList';
                }else {
                    this.listUrl = 'report/repairCwReport/byVehicleList';
                }
                this.getList();
            },
            toDetail(plate, regionId){
                ...
                var url = "";
                if(plate){
                    url = "/tgpt_v2/traffic/repairCw?startTime="+startTime+"&endTime="+endTime+"&plate="+plate;
                }
                if(regionId){
                    url = "/tgpt_v2/traffic/repairCw?startTime="+startTime+"&endTime="+endTime+"&regionId="+regionId;
                }
            ...
            exportExcel(){
                if(this.activeName == "2"){
                    this.excelUrl = 'report/repairCwReport/excelService?';
                }else {
                    this.excelUrl = 'report/repairCwReport/excel?';
                }
            ...
            getFuelConsumption() {
                ...
                ajax.get('report/repairCwReport/getChartData', $this.searchParam).then(res => {
                    if(res.status == 0){
                        let data = {
                            date:[],
                            amount:[],
