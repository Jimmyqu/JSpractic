    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        ...
        <div class="table-box">
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading" border :data="list" style="width: 100%">
				...
				<el-table-column min-width="140" label="周期" prop="cycleText" sortable show-overflow-tooltip></el-table-column>
        ...
        methods: {
            ...
            deleteFence(id){
                this.$confirm('确定删除该时间栅栏?', '提示', {
                    ...
                    ajax.delete('base/baseTimeFence/' + id).then(rs => {
                        this.$message({
                            type: 'success',
                            message: '删除成功!'
                        });
            ...
            exportExcel() {
                window.location = this.exportUrl("base//baseTimeFence//excel?" + $.param(this.searchParam));
            }
        }
    }
</script>
