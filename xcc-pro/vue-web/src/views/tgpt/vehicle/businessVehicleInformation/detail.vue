                ...
                <el-tabs v-model="activeTabName" @tab-click="handleClick">
                    <el-tab-pane label="基本信息" name="first">
                        <div class="flex-panel detail-box">
                            ...
                            <div class="detail-item">
                                <label class="control-label">变速箱类型</label>
                                <div class="input-group">
                            ...
                            <div class="detail-item">
                                <label class="control-label">机动车类型</label>
                                <div class="input-group">
                            ...
                            <div class="detail-item">
                                <label class="control-label">购置金额(万)</label>
                                <div class="input-group">
                                    <span>{{vehicle.price}}</span>
                                </div>
                            </div>
                            <div class="detail-item">
                                <label class="control-label">排放标准</label>
                                <div class="input-group">
                                    <span>{{vehicle.protectionStandard}}</span>
                                </div>
                            </div>
                            <div class="detail-item">
                            ...
                            <div class="detail-item">
                                ...
                                <div class="input-group">
                                    <span>{{vehicle.archivesNo}}</span>
                                </div>
                            </div>
                            <div class="detail-item">
                                <label class="control-label">行驶证图片</label>
                                <div class="input-group">
                                    <upload-panel :size="2" disabled :file-list.sync="licenseimgs"
                            ...
                            <div class="detail-item small">
                                ...
                                <div class="input-group">
                                    <upload-panel :size="2" disabled :file-list.sync="certificateimgs"
                                                  :show-img="true"></upload-panel>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="app-container white-bg list-panel" v-cloak>
                            <div class="table-box">
                                <el-table border :data="list" style="width: 100%">
                                    <el-table-column prop="beforeValue" sortable label="变更前车牌"
                                                     min-width="100"></el-table-column>
                                    <el-table-column prop="afterValue" sortable label="变更后车牌" min-width="140"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="reason" sortable label="变更事由"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="creater" sortable label="变更人"
                                                     min-width="100"></el-table-column>
                                    <el-table-column prop="updateTime" sortable label="变更时间"
                                                     min-width="150"></el-table-column>
                                </el-table>
                                <el-pagination
                    ...
                    <el-tab-pane label="行程数据" name="track" v-if="false">
                        <div class="app-container white-bg list-panel" v-cloak>
                            <div class="table-box">
                                <el-table border :data="list" style="width: 100%">
                                    ...
                                    <el-table-column prop="startTime" sortable label="开始时间"
                                                     min-width="100"></el-table-column>
                                    <el-table-column prop="endTime" sortable label="结束时间" min-width="140"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="totalTime" sortable label="行驶时长(min)"
                                                     min-width="150"></el-table-column>
                                    ...
                                    <el-table-column prop="totalOil" sortable label="耗油量(L)"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="idleTime" sortable label="怠速时长(min)"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="idleFuel" sortable label="怠速耗油量(L)"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="fuelConsumption" sortable label="油耗(L/100km)"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="speed" sortable label="平均车速(km/h)"
                                                     min-width="150"></el-table-column>
                                </el-table>
                                <el-pagination
                                    @size-change="handleSizeChange"
                    ...
                    <el-tab-pane label="年检记录" name="annual" v-if="false">
                        <div class="app-container white-bg list-panel" v-cloak>
                            <div class="table-box">
                                <el-table border :data="list" style="width: 100%">
                                    <el-table-column prop="operateDate" sortable label="年检日期"
                                                     min-width="100"></el-table-column>
                                    <el-table-column prop="result" sortable label="检验结果" min-width="140"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="effectiveDate" sortable label="合格有效期至"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="department" sortable label="年检单位"
                                                     min-width="100"></el-table-column>
                                    <el-table-column prop="cost" sortable label="年检费用"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="operator" sortable label="办理人"
                                                     min-width="150"></el-table-column>
                                </el-table>
                                <el-pagination
                                    @size-change="handleSizeChange"
                    ...
                    <el-tab-pane label="设备绑定记录" name="third" v-if="false">
                        <div class="app-container white-bg list-panel" v-cloak>
                            <div class="table-box">
                                <el-table border :data="list" style="width: 100%">
                                    <el-table-column prop="equipmentType" sortable label="设备类型"
                                                     min-width="140"></el-table-column>
                                    <el-table-column prop="sn" sortable label="设备号SN" min-width="140"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="imei" sortable label="IMEI"
                                                     min-width="140"></el-table-column>
                                    <el-table-column prop="typeName" sortable label="操作类型"
                                                     min-width="120"></el-table-column>
                                    <el-table-column prop="equipmentModalName" sortable label="产品型号"
                                                     min-width="120"></el-table-column>
                                    <el-table-column prop="installSit" sortable label="安装位置"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="creater" sortable label="操作人"
                                                     min-width="120"></el-table-column>
                                    <el-table-column prop="createTime" sortable label="操作时间"
                                                     min-width="120"></el-table-column>
                                    <el-table-column prop="remark" sortable label="操作说明"
                                                     min-width="150"></el-table-column>
                                </el-table>
                                <el-pagination
                                    @size-change="handleSizeChange"
                    ...
                    <el-tab-pane label="服役记录" name="fourth" v-if="false">
                        <!-- <span style="margin-left: 25px;"><font color="#FF0000">服役记录列表需求暂未明确！！！</font></span>-->
                        <div class="app-container white-bg list-panel" v-cloak>
                            <div class="table-box">
                                <el-table border :data="list" style="width: 100%">
                                    <el-table-column prop="contractType" sortable label="服务类型"
                                                     min-width="100"></el-table-column>
                                    <el-table-column prop="enterpriseName" sortable label="服务客户" min-width="140"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="contractNumber" sortable label="合同编号"
                                                     min-width="150"></el-table-column>
                                    <el-table-column prop="serviceStatus" sortable label="服务状态"
                                                     min-width="100"></el-table-column>
                                    <el-table-column prop="contractStartDate" sortable label="服务开始时间"
                                                     min-width="120"></el-table-column>
                                    <el-table-column prop="contractEndDate" sortable label="服务结束时间"
                                                     min-width="120"></el-table-column>
                                    <el-table-column prop="contractAmount" sortable label="租金"
                                                     min-width="120"></el-table-column>
                                </el-table>
                                <el-pagination
                                    @size-change="handleSizeChange"
                    ...
                    <el-tab-pane label="加油记录" name="fifth" v-if="false">
                        <div class="app-container white-bg list-panel" v-cloak>
                            <div class="table-box">
                                <el-table border :data="list" style="width: 100%">
                                    <el-table-column prop="orderNo" sortable label="加油单号" min-width="180"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="addOilTime" sortable label="加油时间" min-width="140"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="addOilPlace" sortable label="加油地点" min-width="200"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="addOilReason" sortable label="加油原因" min-width="120"
                                                     show-overflow-tooltip></el-table-column>
                                    <el-table-column prop="driverName" sortable label="驾驶员"
                                                     min-width="120"></el-table-column>
                                    <el-table-column prop="oilTotalAmount" sortable label="加油金额（元）"
                                                     min-width="120"></el-table-column>
                                    ...
                                    <el-table-column prop="billStatus" sortable label="状态"
                                                     min-width="120"></el-table-column>
                                </el-table>
                                <el-pagination
                                    @size-change="handleSizeChange"
                    ...
                    <el-tab-pane label="保险记录" name="sixth" v-if="false">
                        <div class="table-box">
                            <el-table border :data="list" style="width: 100%">
                                <el-table-column prop="policyNumber" sortable label="保险单号"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="insuranceTypeName" sortable label="保险类型" min-width="140"
                                                 show-overflow-tooltip></el-table-column>
                                <el-table-column prop="insuranceCompanyName" sortable label="保险公司"
                                                 min-width="150"></el-table-column>
                                <el-table-column prop="insuredDate" sortable label="投保日"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="expiryDate" sortable label="到期日"
                                                 min-width="150"></el-table-column>
                                <el-table-column prop="warrantyStatusName" sortable label="保单状态"
                                                 min-width="150"></el-table-column>
                                <el-table-column prop="insuranceCost" sortable label="保费（元）"
                                                 min-width="150"></el-table-column>
                            </el-table>
                            <el-pagination
                                @size-change="handleSizeChange"
                    ...
                    <el-tab-pane label="维保记录" name="seventh" v-if="false">
                        <div class="table-box">
                            <el-table border :data="list" style="width: 100%">
                                <el-table-column prop="maintenanceNo" sortable label="维保单号"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="maintenanceType" sortable label="维保类型" min-width="140"
                                                 show-overflow-tooltip></el-table-column>
                                <el-table-column prop="totalPrice" sortable label="维保费用（元）"
                                                 min-width="150"></el-table-column>
                                <el-table-column prop="arriveRepairTime" sortable label="送修日期"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="fetchCarTime" sortable label="提车日期"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="billStatus" sortable label="状态"
                                                 min-width="150"></el-table-column>
                            </el-table>
                    ...
                    <el-tab-pane label="事故记录" name="eighth" v-if=false>
                        <div class="table-box">
                            <el-table border :data="list" style="width: 100%">
                                <el-table-column prop="code" sortable label="事故单号" min-width="150"></el-table-column>
                                <el-table-column prop="accidentTime" sortable label="事故发生时间" min-width="120"
                                                 show-overflow-tooltip></el-table-column>
                                <el-table-column prop="accidentPlace" sortable label="事故地点"
                                                 min-width="150"></el-table-column>
                                <el-table-column prop="accidentCauseName" sortable label="事故起因"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="accidentSquareName" sortable label="事故方"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="accidentResponsibilityName" sortable label="事故责任"
                                                 min-width="100"></el-table-column>
                                <el-table-column prop="accidentGradeName" sortable label="事故等级"
                                                 min-width="120"></el-table-column>
                                <el-table-column prop="userName" sortable label="事故经手人"
                                                 min-width="150"></el-table-column>
                                <el-table-column prop="accidentAmount" sortable label="事故总金额（元）"
                                                 min-width="150"></el-table-column>
                                <el-table-column prop="billStatus" sortable label="状态"
                                                 min-width="150"></el-table-column>
                            </el-table>
        ...
        methods: {
            handleClick(tab, event) {
                ...
                this.searchParam = {
                    ...
                    vehicleSource: this.vehicle.vehicleSource
                };
                this.getList();
            },
            detail() {
                const id = this.$route.params.id
                ajax.get("base/business/vehicle/detail/" + id).then(res => {
