            ...
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading"border :data="list" style="width: 100%">
                ...
                <el-table-column fixed="left" label="操作" width="150">
                    <template slot-scope="scope">
                        <a size="mini" @click="toDetail(scope.row)">查看位置</a>
                    </template>
                </el-table-column>
				...
				<el-table-column min-width="140" label="持续时长" prop="durationStr" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="最大强度" prop="maxStrength" sortable show-overflow-tooltip></el-table-column>
				<el-table-column min-width="140" label="地点" prop="address" sortable show-overflow-tooltip></el-table-column>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            detail(row){
                let url = `/tgpt/vehicle/vehicleInformation/detail/${row.relationId}`
            ...
            exportExcel() {
                ...
                window.location = this.exportUrl("obd//obdAlarmVibration//excel?" + $.param(this.searchParam));
            },
            updateDateChange() {
                if(this.updateDate && this.updateDate.length>0){
                    let updateDate = this.updateDate;
