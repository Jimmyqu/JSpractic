            ...
            <el-collapse v-model="activeNames">
                ...
                <el-collapse-item title="合同基本信息" name="1">
                    <div class="flex-panel">
                        ...
                        <el-form-item label="申请日期" prop="applicationDate" :rules="rules.required('请选择申请日期')">
                            <el-date-picker type="date" placeholder="请选择" v-model="ruleForm.applicationDate" disabled
                        ...
                        <el-form-item label="合同开始日期" prop="contractStartDate" :rules="rules.required('请选择合同开始日期')">
                            <el-date-picker type="date" placeholder="请选择" v-model="ruleForm.contractStartDate" disabled
                        ...
                        <el-form-item label="交车日期" prop="deliveryDate" :rules="rules.required('请选择交车日期')">
                            <el-date-picker type="date" placeholder="请选择" v-model="ruleForm.deliveryDate" disabled
                                            value-format="yyyy-MM-dd" :editable="false"></el-date-picker>
                        </el-form-item>
                       ...
                       <!-- <el-form-item label="报价模板" prop="quotationTemplate" :rules="rules.required('请选择报价模板')">-->
                        <el-form-item label="报价模板" prop="quotationTemplate" >
                            <el-select v-model="ruleForm.quotationTemplate" placeholder="请选择" disabled>
                                <el-option label="配驾" :value="1"></el-option>
                                <el-option label="自驾" :value="2"></el-option>
                            </el-select>
                        </el-form-item>
                        <el-form-item label="报价范围">
                            <el-select v-model="ruleForm.quotationRange" placeholder="请选择" disabled>
                        ...
                        <el-form-item label="购买保险方式" prop="insurancePurchaseMode" :rules="rules.required('请选择购买保险方式')">
                            <el-select v-model="ruleForm.insurancePurchaseMode" placeholder="请选择" disabled>
                        ...
                        <el-form-item label="违章代办方式" prop="peccancyHandleMode" :rules="rules.required('请选择违章代办方式')">
                            <el-select v-model="ruleForm.peccancyHandleMode" placeholder="请选择" disabled>
                        ...
                        <el-form-item label="我方签约主体" prop="ourContractSubject" :rules="rules.required('请选择我方签约主体')">
                            <el-select v-model="ruleForm.ourContractSubject" placeholder="请选择" disabled>
                        ...
                        <el-form-item label="合同议定方" prop="contractAgreedParty" :rules="rules.required('请选择合同议定方')">
                            <el-select v-model="ruleForm.contractAgreedParty" placeholder="请选择" disabled>
                        ...
                        <el-form-item label="合同文本类型" prop="contractTextType" :rules="rules.required('请选择合同文本类型')">
                            <el-select v-model="ruleForm.contractTextType" placeholder="请选择" disabled>
                        ...
                        <el-form-item label="押金条件" prop="depositCondition">
                            <el-input v-model="ruleForm.depositCondition" maxlength="50" placeholder="请输入" disabled></el-input>
                        </el-form-item>
                        <el-form-item label="用印地点">
                            <el-select v-model="ruleForm.useSealPlace" placeholder="请选择" disabled>
                ...
                <el-collapse-item title="合同费用信息" name="2">
                    <div class="flex-panel">
                        ...
                        <el-form-item label="结算方式" prop="settlementModel" :rules="rules.required('请选择结算方式')">
                            <el-select placeholder="请选择结算方式" v-model="ruleForm.settlementModel">
                        ...
                        <el-form-item label="付款方式" prop="paymentModel":rules="rules.required('请选择付款方式')">
                            <el-select placeholder="请选择付款方式" v-model="ruleForm.paymentModel">
                        ...
                        <el-form-item label="合同金额" prop="contractAmount" :rules="rules.money(true)" >
                            <el-input v-model="ruleForm.contractAmount" placeholder="请输入">
                                <template slot="append">元</template>
                            </el-input>
                        </el-form-item>
                ...
                <el-collapse-item title="合同条款" name="3">
                    ...
                    <el-form-item label="备注" class="big">
                        <el-input type="textarea" v-model="ruleForm.remark" maxlength="2000" disabled></el-input>
                    </el-form-item>
                </el-collapse-item>
                ...
                <el-collapse-item title="合同明细" name="5">
                    ...
                    <el-table class="left" border :data="ruleForm.projectContractExecuteDetailList" style="width: 100%">
                        ...
                        <el-table-column label="服务组织" min-width="150" label-class-name="required">
                            <template slot-scope="{row,$index}" >
                                <el-form-item  :prop="'projectContractExecuteDetailList.' + $index + '.serviceOrganizationId'"
                                    ...
                                    <tree-select v-model="row.serviceOrganizationId" placeholder="请选择组织" type="one" :disabled="row.isNew==0"
                        ...
                        <el-table-column label="结算组织" min-width="150" label-class-name="required">
                            <template slot-scope="{row,$index}" >
                                <el-form-item  :prop="'projectContractExecuteDetailList.' + $index + '.settlementOrganizationId'"
                                    ...
                                    <tree-select v-model="row.settlementOrganizationId" placeholder="请选择组织" type="one" :disabled="row.isNew==0"
                                                 url="admin/organization/companyTree"></tree-select>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="useCarCityName" show-overflow-tooltip label="用车城市" min-width="150">
                            <template slot-scope="{row,$index}" >
                                <el-form-item prop="city">
                                    <city-select :value.sync="row.city" :disabled="row.isNew==0" :ref="'citySelect_' + $index">
                                    </city-select>
                                </el-form-item>
                            ...
                            <template slot-scope="{row,$index}" >
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.dataModel'" :rules="rules.required('请选择车型')">
                                    <el-input type="text"  placeholder="请选择车型" v-model="row.dataModel"
                                              size="small" :disabled="row.isNew==0"
                                              @click.native="openDialogVehicleModelInfo($index,row.isNew)">
                                    </el-input>
                                </el-form-item>
                            ...
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.useCarStartDate'"  :rules="rules.required('请选择用车开始时间')">
                                    <el-date-picker type="date" placeholder="请选择" v-model="row.useCarStartDate"
                                                    value-format="yyyy-MM-dd" :picker-options="row.useCarStartDate" :disabled="row.isNew==0"
                                                    :editable="false"></el-date-picker>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="carColorName" label="颜色" min-width="150">
                            <template slot-scope="{row,$index}" >
                                <el-form-item prop="carColor">
                                    <el-select v-model="row.carColor" :disabled="row.isNew==0" placeholder="请选择">
                        ...
                        <el-table-column label="每月车辆租金(元)" min-width="150" label-class-name="required">
                            <template slot-scope="{row,$index}" >
                                <el-form-item  :prop="'projectContractExecuteDetailList.' + $index + '.carRentMonth'"
                                    ...
                                    <el-input v-model="row.carRentMonth" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column label="测算租金(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.calculatePrice'"  :rules="rules.money(false)">
                                    <el-input v-model="row.calculatePrice" :disabled="row.isNew==0" placeholder="请输入"></el-input>
                                </el-form-item>
                        ...
                        <el-table-column prop="vehicleQty" label="车辆台数（台）" min-width="150" label-class-name="required">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.vehicleQty'" :rules="[{ validator: formRule.standardSize,message: '请输入整数', trigger: 'change' },{required: true, message: '请输入车辆台数', trigger: 'change'}]">
                                    <el-input v-model="row.vehicleQty" @blur="changeDriverCount(row)" :disabled="row.isNew==0" placeholder="请输入"></el-input>
                                </el-form-item>
                        ...
                        <el-table-column prop="oilFeePaymenModel" label="油费支付类型" min-width="150" label-class-name="required">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index  + '.oilFeePaymenModel'"
                                    ...
                                    <el-select v-model="row.oilFeePaymenModel" :disabled="row.isNew==0" placeholder="请选择">
                        ...
                        <el-table-column label="每月车辆油费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.carOilCostMonth'"
                                    ...
                                    <el-input v-model.number="row.carOilCostMonth" :disabled="row.isNew==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="每月限制里程公里" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.limitMileageMonth'"
                                    ...
                                    <el-input v-model="row.limitMileageMonth" :disabled="row.isNew==0" placeholder="请输入" maxlength="10"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column label="超里程单价(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.overMileagePrice'"
                                    ...
                                    <el-input v-model="row.overMileagePrice" :disabled="row.isNew==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column label="ETC费(元)" min-width="200">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.etcCost'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.etcCost" :disabled="row.isNew==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="retrofitRequirement" label="加装要求" min-width="200">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.retrofitRequirement'">
                                    <el-input v-model="row.retrofitRequirement" :disabled="row.isNew==0" placeholder="请输入"></el-input>
                                </el-form-item>
                        ...
                        <el-table-column prop="procurementExplanation" label="采购说明" min-width="200">
                            <template slot-scope="{row,$index}">
                                <el-form-item :prop="'projectContractExecuteDetailList.' + $index + '.procurementExplanation'">
                                    <el-input v-model="row.procurementExplanation" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                        ...
                        <el-table-column prop="retrofitRequirementOptionsText" label="加装要求选项" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item>
                                    <el-select v-model="row.retrofitRequirementOptionsList" multiple :disabled="row.isNew ==0"
                                               placeholder="请选择">
                                        <el-option
                        ...
                        <el-table-column label="是否需要司机" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item >
                                    <el-checkbox v-model="row.isNeedDriverBoolean" :disabled="row.isNew ==0" @click.native="changeNeedDriver(row)">是</el-checkbox>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="司机每天工作时长(小时)" min-width="170">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.driverWorktimeDay'"
                                    ...
                                    <el-input v-model="row.driverWorktimeDay" placeholder="请输入" :disabled="row.isNew ==0" ></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column prop="date" label="每月司机费用(元)" min-width="150" label-class-name="required">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.driverCostMonth'"
                                    ...
                                    <el-input v-model="row.driverCostMonth" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="每月司机通讯费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.driverCommunicationCostMonth'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.driverCommunicationCostMonth" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="代驾费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.drivingCost'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.drivingCost" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="加班费（小时）" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.overtimeCost'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.overtimeCost" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="每晚住宿费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.stayCost'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.stayCost" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="餐费（次）" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean":prop="'projectContractExecuteDetailList.' + $index + '.mealCost'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.mealCost" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="福利费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.welfareFee'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.welfareFee" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="年高温补贴费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.highTemperatureFee'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.highTemperatureFee" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="年生日补贴费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.birthdayFee'"
                                              :rules="rules.money(false)">
                                    <el-input v-model="row.birthdayFee" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="其他补贴费(元)" min-width="150">
                            <template slot-scope="{row,$index}">
                                <el-form-item v-if="row.isNeedDriverBoolean" :prop="'projectContractExecuteDetailList.' + $index + '.otherSubsidyCost'"
                                              :rules="rules.money(false)">
                                    <el-input  v-model="row.otherSubsidyCost" :disabled="row.isNew ==0" placeholder="请输入"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        <el-table-column prop="date" label="其他费用说明" min-width="150">
                            <template slot-scope="{row}">
                                <el-form-item v-if="row.isNeedDriverBoolean" >
                                    <el-input v-model="row.otherCostExplanation" :disabled="row.isNew==0" placeholder="请输入" maxlength="50"></el-input>
                                </el-form-item>
                            </template>
                        </el-table-column>
                        ...
                        <el-table-column label="操作" min-width="120">
                            <template slot-scope="{row,$index}">
                                <el-form-item>
                                    <el-button type="text"
                                               @click="deleteItem($index,row.isNew)"
    ...
    export default {
        ...
        data() {
            ...
            return {
                ...
                saveDisabled:false,
                editFlag:this.type == 2,//执行时明细可编辑，编辑时明细不可编辑
                type:2,
        ...
        methods: {
            ...
            open(){
                ...
                this.editRenew = this.$route.query.editRenew;
                this.type = 2;
                this.setInitData();
                this.initFormData();
            },
            ...
            getFormData: function (id) {
                ...
                this.confirmType=[];
                debugger
                ajax.get("core/coreProjectContract/getRenewDetail?id=" + id+"&editRenew="+this.editRenew).then(result =>{
                    if (result.status == 0) {
                        if( result.data[0]){
            ...
            save() {
                this.$refs.ruleForm.validate((valid) => {
                    if (valid) {
                        ...
                        console.log(params)
                        let url="";
                        params.editRenew=this.editRenew;
                        if(this.editRenew==0)
                           url="/core/coreProjectContract/renew";
                        else if(this.editRenew==1)
                            url="/core/coreProjectContract/addOrEdit";
                            params.projectContractDetailList=params.projectContractExecuteDetailList;
            ...
            openDialogVehicleModelInfo(i,isNew){
                if(isNew==0){
            ...
            deleteItem(index,isNew) {
                ...
                if(this.type == 2){//处于合同执行编辑模式
                    if(isNew == 0 ){
                        this.$message.error('合同续签不允许删除合同执行明细');
                        return;
                    }
                }
