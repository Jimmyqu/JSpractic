    ...
    <div class="map_wrap parking">
        ...
        <el-card class="box-card map_right_card">
            <el-form :model="addForm" :rules="rules" label-position="right" ref="addForm" label-width="100px" v-cloak>
                ...
                <el-form-item class="big" label="停车时间段" prop="vehicleCount">
                ...
                <div class="left-row" style="margin-top: 25px;padding-left: 0;text-align: right">
...
<script>
    ...
    export default {
        ...
        activated(){
            ...
            if(this.$store.state.isElectronPicture || this.$store.state.isPicture || flag ){
        ...
        methods: {
            handleDrawingManager(value){
                ...
                if(value ==  'circlecomplete'){
                    ...
                    this.$store.state.isParkingPicture = true
                    ...
                    if(this.$store.state.isParkingPicture){
                        this.$store.state.isPicture = true
                    }
                    this.$store.state.isParkingPicture = false
                    if($('.BMapLib_hander')[0]){
            ...
            open() {
                ...
                if (this.$route.query.id) {
                    ajax.get('/base/baseParking/' + this.$route.query.id).then(rs => {
            ...
            submitForm: function (form) {
                ...
                this.$refs[form].validate((valid) => {
                    ...
                    ajax.post('/base/baseParking', data).then(rs => {
                        if (rs.status == 0) {
                            this.$message({
                                message: '操作成功',
                                type: 'success'
            ...
            initialize(echarts) {
                ...
                //     script.onload = this.initDrawingManager;
                // }else{
                // }
