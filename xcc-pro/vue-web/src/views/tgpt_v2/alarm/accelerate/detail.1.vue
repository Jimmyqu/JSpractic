        ...
        <el-collapse v-model="openCollapse">
            <el-collapse-item title="车辆详情" name="1" >
                <div class="flex-panel detail-box">
                    ...
                    <div class="detail-item">
                        <label class="control-label">加速度(m/s²)</label>
                        <div class="input-group">
                            <span>{{detailForm.accelerate}}</span>
                        </div>
                    </div>
                    <div class="detail-item">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            gpsTrack1(){
                ajax.get('obd/obdAlarmAccelerate/detail/' + this.id,).then(rs => {
            ...
            gpsTrack2(){
                ...
                ajax.post('obd/obdAlarmAccelerate/detailMap', this.detailForm).then(rs => {
                    loading.close();
                    if(rs.status == 0){
                        /*划线*/
                        let pointList = [];
