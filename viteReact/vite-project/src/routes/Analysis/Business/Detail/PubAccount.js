...
class AnalysisBusinessDetailPubAccount extends Component {
  ...
  columns = [
    ...
    {
      title: '发生金额',
      dataIndex: 'analysisPublicAccount.amount',
    ...
    // {
    //   title: '现金流水金额',
    //   dataIndex: 'analysisPublicAccount.cashFlowAmount',
    //   render: this.moneyRender,
    //   collect: true,
    //   width: 120,
    // },
    // {
    //   title: '消费收入金额',
    //   dataIndex: 'analysisPublicAccount.consumeFlowAmount',
    //   render: this.moneyRender,
    //   collect: true,
    //   width: 120,
    // },
  ...
  render() {
    return (
      <Card bordered={false}>
        <Datatable
          url="/analysis/publicAccount/detail.do"
          columns={this.columns}
          rowKey={record => record.analysisPublicAccount.id}
...
export default AnalysisBusinessDetailPubAccount;
