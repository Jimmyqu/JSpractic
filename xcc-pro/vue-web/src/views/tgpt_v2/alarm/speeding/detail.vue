        ...
        <div class="detail__dialog detail-box " v-drag-dialog>
            ...
            <div class="flex-panel detail-body">
                ...
                <div class="detail-item">
                    ...
                    <div class="input-group">
                        <span>{{detailForm.updateTimer}}</span>
                    </div>
                </div>
                <div class="detail-item">
                    <label class="control-label">超速时长</label>
                    <div class="input-group">
                        <span>{{detailForm.timeduration}}</span>
                    </div>
                </div>
                <div class="detail-item">
                    <label class="control-label">超速里程(km)</label>
                    <div class="input-group">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            gpsTrack1(){
                ajax.get('obd/obdAlarmSpeeding/detail/' + this.id,).then(rs => {
            ...
            gpsTrack2(){
                ...
                ajax.post('obd/obdAlarmSpeeding/detailMap', this.detailForm).then(rs => {
                    loading.close();
                    if(rs.status == 0){
                        /*划线*/
                        let pointList = [];
