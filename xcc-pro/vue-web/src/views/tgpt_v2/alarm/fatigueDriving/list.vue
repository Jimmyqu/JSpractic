            ...
            <div class="form-box">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <el-select v-model="searchParam.alarmType" clearable placeholder="请选车辆所属">
                            <el-option label="自有车辆" :value="1"></el-option>
                            <el-option label="挂靠车辆" :value="2"></el-option>
                            <el-option label="个人车辆" :value="3"></el-option>
                        </el-select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <el-select v-model="searchParam.duration" clearable placeholder="请选择时长范围">
                            <el-option label="30分钟以下" :value="1"></el-option>
                            <el-option label="30到60分钟" :value="2"></el-option>
                            <el-option label="60分钟以上" :value="3"></el-option>
                        </el-select>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <el-select v-model="searchParam.type" clearable placeholder="请选择时长范围">
                            <!--<el-option label="全选" :value="1"></el-option>-->
                            <el-option label="单次超时" :value="2"></el-option>
                            <el-option label="累计超时" :value="3"></el-option>
                        </el-select>
                    </div>
                </div>
            ...
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading" border :data="list" style="width: 100%">
                <el-table-column fixed="left" label="操作" width="150">
                    <template slot-scope="scope">
                        <el-button v-show="showDetailBtn" type="text" @click="detail(scope.row.id)">查看详情</el-button>
                    </template>
                </el-table-column>
                ...
                <el-table-column min-width="140" label="报警类型" prop="alarmType" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="报警时间" prop="alarmTime" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="超时时长" prop="timeduration" sortable show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listUrl: 'obd//obdAlarmFatigueDriving'
            }
        },
        activated(){
            this.getList();
        ...
        methods: {
            ...
            exportExcel() {
                ...
                window.location = this.exportUrl("obd//obdAlarmFatigueDriving//excel?" + $.param(this.searchParam));
            },
