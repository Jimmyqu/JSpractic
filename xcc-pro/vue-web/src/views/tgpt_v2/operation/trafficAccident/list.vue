    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        ...
        <div class="search-box" :class="{'hide-search':!showSearch}">
            <div class="form-box">
                ...
                <div class="form-group">
                    <label class="control-label">事故日期</label>
                    <div class="input-group">
                        <el-date-picker
                            v-model="createTime"
                            type="datetimerange"
        ...
        <div class="table-box">
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading":data="list" style="width: 100%" border>
                ...
                <el-table-column prop="accidentNum" sortable label="事故编号" show-overflow-tooltip min-width="140">
                    <template slot-scope="scope">
                        <a size="mini" @click="detail(scope.row)">{{scope.row.accidentNum}}</a>
                    </template>
                </el-table-column>
                ...
                <el-table-column prop="accidentTime" sortable label="事故时间" min-width="120"></el-table-column>
                <el-table-column prop="accidentArea" sortable label="事故地点" min-width="180"></el-table-column>
...
<script>
    ...
    export default {
        ...
        data(){
            return {
                showSearch: false,
                showConfirmBtn:this.getCurrentUserAuthority("accident/confirm"),
                //showDeleteBtn: this.getCurrentUserAuthority("driver/delete"),
                listUrl:"operation_traffic/accident",
                companyIds:[],
                createTime: []
            }
        },
        ...
        methods: {
            ...
            detail(row) {
                this.$router.push({path:"/tgpt_v2/operation/trafficAccident/detail/"+row.id});
            },
            confirm(row) {
                this.$router.push({path:"/tgpt_v2/operation/trafficAccident/confirm/"+row.id});
            },
            changeOrganization(){
