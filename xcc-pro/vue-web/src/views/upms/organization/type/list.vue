    ...
    <div class="app-container white-bg list-panel" v-cloak>
        <div class="tree-box">
            ...
            <div class="tree-content">
                <tree-panel ref="tree" url="admin/organization/typeTree"
            ...
            <el-form :model="editForm" ref="editForm" label-position="top" label-width="100px">
                <el-form-item label="上级组织" prop="parentId" v-if="parentShow" :rules="rules.required('请选择上级组织')">
                    ...
                    <tree-select v-model="editForm.parentId" placeholder="请选择" type="one"
                                 url="admin/organization/typeTree" :params="params"></tree-select>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                showAdd: this.getCurrentUserAuthority("sys/organizationType/insert"),
                showEdit: this.getCurrentUserAuthority("sys/organizationType/update"),
        ...
        methods: {
            ...
            getOrganizationDetail(id) {
                ajax.get("admin/organization/type/" + id).then(result => {
            ...
            add() {
                this.$refs["editForm"].validate((valid) => {
                    ...
                    ajax.post('admin/organization/type', params).then(res => {
