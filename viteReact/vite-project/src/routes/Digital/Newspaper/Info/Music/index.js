...
export default function () {
  ...
  const templateType = PaperConfigurations.BG_MUSIC.key;
  ...
  const columns = useMemo(
    () => [
      ...
      {
        title: '链接地址',
        dataIndex: 'fileItem.url',
        render: (value, { fileItem }) =>
          fileItem && (
            <a href={fileItem.url} rel="noopener noreferrer" target="_blank">
              {value}
            </a>
          ),
        width: 200,
