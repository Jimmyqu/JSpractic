            ...
            <el-table border :data="list" style="width: 100%" height="calc(100vh - 450px)">
               ...
               <el-table-column fixed="left" label="选择" width="80">
                ...
                <el-table-column prop="assetsTypeVal" sortable label="车辆所属" min-width="100"
                                 show-overflow-tooltip></el-table-column>
                <el-table-column prop="attributionRegionVal" sortable label="服务组织" min-width="100"
                                 show-overflow-tooltip></el-table-column>
                <el-table-column prop="vehicleModelInfo" sortable label="车型" min-width="300"
                                 show-overflow-tooltip></el-table-column>
                <el-table-column prop="areaCount" sortable label="关联围栏" min-width="100"
                        ...
                        <el-popover v-if="scope.row.areaCount > 0"
                            ...
                            <ul class="_a_v_ul_list">
                                <li v-for="(va,i) in scope.row.vas" :key="i">
                                    ...
                                    <div class="city_wrap">停车时间: {{va.cityName}}</div>
                                </li>
                            </ul>
    ...
    export default {
        ...
        data() {
            return {
                ...
                searchParam: {},
                regions:[],
                listUrl: '/base/baseParking/vehicle',
                areaId: '',
                treeUrl:""
            }
        },
        methods: {
            ...
            dblClickHandle() {
                ...
                this.$confirm('确定添加（' + length + '）辆车?')
                    .then(() => {
                        ajax.post('/base/baseParking/areaFenceToVehicle', {areaId: this.areaId, vehicleIds: vehicleIds})
                            .then(res => {
                               if(res.status==0) {
