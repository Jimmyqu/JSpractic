    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        <div class="search-box" :class="{'hide-search':!showSearch}">
            ...
            <div class="search-btn-list">
                <i class="el-icon-arrow-right" @click="showSearch=!showSearch" clearable></i>
            </div>
        </div>
        <div class="tool-box">
            <div class="operation">
            ...
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading"border :data="list" style="width: 100%">
                ...
                <el-table-column fixed="left" label="操作" width="150">
                    <template slot-scope="scope">
                        <a size="mini" @click="toDetail(scope.row)">水温趋势</a>
				...
				<el-table-column min-width="140" label="解除时间" prop="liftTime" sortable show-overflow-tooltip></el-table-column>
                <el-table-column min-width="140" label="最高水温" prop="maxTemperature" sortable show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        data() {
            return {
                ...
                updateDate:[],
                organization:[],
                listUrl: 'obd//obdAlarmWaterTemperature'
            }
        },
        activated(){
            this.getList();
        ...
        methods: {
            ...
            exportExcel() {
                ...
                window.location = this.exportUrl("obd//obdAlarmWaterTemperature//excel?" + $.param(this.searchParam));
            },
