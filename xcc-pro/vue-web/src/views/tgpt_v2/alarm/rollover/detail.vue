    ...
    <div class="newDetail-panel">
        ...
        <div class="detail__dialog detail-box detail-box1" style="top:300px" v-drag-dialog>
            ...
            <div class="flex-panel detail-body">
                ...
                <div class="detail-item">
                    <label class="control-label">侧翻方向</label>
                    <div class="input-group">
                        <el-tooltip :disabled="isShowTooltip(detailForm.direction)" effect="dark" :content="detailForm.direction" placement="top">
                            <span>{{detailForm.direction}}</span>
                        </el-tooltip>
                    </div>
                </div>
                <div class="detail-item">
                    <label class="control-label">侧翻角度</label>
                    <div class="input-group">
                        <el-tooltip :disabled="isShowTooltip(detailForm.angle)" effect="dark" :content="detailForm.angle" placement="top">
                ...
                <div class="detail-item">
                    ...
                    <div class="input-group">
                        <span>{{detailForm.brakeLength}}</span>
                    </div>
                </div>
                <div class="detail-item">
                ...
                <div class="detail-item">
                    ...
                    <div class="input-group">
                        <span>{{detailForm.barkeDistance}}</span>
                    </div>
                </div>
                <div class="detail-item">
                    <label class="control-label">故障情况</label>
                    <div class="input-group">
                        <el-tooltip :disabled="isShowTooltip('')" effect="dark" :content="''" placement="top">
                            <span></span>
                        </el-tooltip>
                    </div>
                </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            console.log(this.id)
            ajax.get('obd/obdAlarmRollover/detail/' + this.id,).then(rs => {
            ...
            ajax.get('obd/obdAlarmRollover/findVehicleStatusByVehicleId/' + this.id).then(rs => {
                ...
                var new_point = new BMap.Point(currentVehicleTrack.rlongitude, currentVehicleTrack.rlatitude);
