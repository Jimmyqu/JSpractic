    ...
    <div class="app-container white-bg list-panel newList-panel" v-cloak>
        <div class="search-box" :class="{'hide-search':!showSearch}">
            <div class="form-box">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <el-input  v-model="searchParam.brand" placeholder="请选择" clearable>
                        </el-input>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <el-input  v-model="searchParam.series" placeholder="请选择" clearable>
                        </el-input>
                    </div>
                </div>
            </div>
        ...
        <div class="content" v-loading="listLoading">
                            ...
                            <el-table :ref="getRefName" :max-height="tableHeight" border :data="list" style="width: 100%" show-summary>
                                <el-table-column prop="plate" sortable label="车牌" min-width="100">
                                    <template slot-scope="scope">
                                        <a size="mini" @click="toVehicleDetail(scope.row.relationId)">{{scope.row.plate}}</a>
                                    </template>
                                </el-table-column>
                                <el-table-column prop="vehicleModelInfoName" sortable label="车型" min-width="300"></el-table-column>
                                <el-table-column prop="assetsType" sortable label="车辆所属" min-width="100"></el-table-column>
                                <el-table-column prop="region" sortable label="所属组织" min-width="200"></el-table-column>
                                <el-table-column prop="count" sortable label="维修次数" min-width="100"></el-table-column>
                                <el-table-column prop="totalPrice" sortable label="维修总金额(元)" min-width="120"></el-table-column>
                                <el-table-column prop="cvmaprice" sortable label="配件费用(元)" min-width="120"></el-table-column>
                    ...
                    <div class="table-box table-box-more">
                        <div class="table-content">
                            <el-table :ref="getRefName" :max-height="tableHeight" border :data="list" style="width: 100%" show-summary>
                                ...
                                <el-table-column prop="region" sortable label="所属组织" min-width="200"></el-table-column>
                                <el-table-column prop="count" sortable label="维修总次数" min-width="100"></el-table-column>
                                <el-table-column prop="totalPrice" sortable label="维修总金额(元)" min-width="120"></el-table-column>
                                <el-table-column label="操作" min-width="100">
                                    <template slot-scope="scope">
            ...
            <div class="content-right">
                <p class="register">维修总金额：<span class="text-green">{{totalPrice}} 元</span></p>
    ...
    export default {
        ...
        data() {
            return {
                ...
                listUrl: 'report/maintainCostReportController/byVehicleList',
                excelUrl: 'report/maintainCostReportController/excel',
                showExportExcelBtn: this.getCurrentUserAuthority('maintainCost/exportExcel'),
                showSearch: false,
                carUseMonth: [],
                originateDeptId: [],
                totalPrice: 0
        ...
        methods: {
            ...
            handleClick(){
                if(this.activeName == "2"){
                    this.listUrl = 'report/maintainCostReportController/byServiceList';
                }else {
                    this.listUrl = 'report/maintainCostReportController/byVehicleList';
                }
                this.getList();
            },
            toDetail(plate, regionId){
                ...
                var url = "";
                if(plate){
                    url = "/tgpt_v2/report/vehicleMaintenanceReport?startTime="+startTime+"&endTime="+endTime+"&plate="+plate;
                }
                if(regionId){
                    url = "/tgpt_v2/report/vehicleMaintenanceReport?startTime="+startTime+"&endTime="+endTime+"&regionId="+regionId;
                }
                this.$router.push({path:url + "&type=1,3"});
            },
            ...
            exportExcel(){
                debugger
                if(this.activeName == "2"){
                    this.excelUrl = 'report/maintainCostReportController/excelService?';
                }else {
                    this.excelUrl = 'report/maintainCostReportController/excel?';
                }
            ...
            getFuelConsumption() {
                ...
                ajax.get('report/maintainCostReportController/getChartData', $this.searchParam).then(res => {
                    if(res.status == 0){
                        let data = {
                            date:[],
                            money:[],
                        ...
                        for (let i=0;i < res.data.length;i++) {
                            ...
                            data.date.push(item.arriveRepairTime)
                            data.money.push(item.totalPrice)
