<template>
    <div class="app-container white-bg list-panel list-panel newList-panel" v-cloak>
        ...
        <div class="table-box">
            <el-table :ref="getRefName" :max-height="tableHeight" v-loading="listLoading"border :data="list" style="width: 100%">
                ...
                <el-table-column min-width="140" label="角速度(rad/s)" prop="acceleration" sortable show-overflow-tooltip></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            exportExcel() {
                ...
                window.location = this.exportUrl("obd//obdAlarmSharpTurn//excel?" + $.param(this.searchParam));
            },
