        ...
        <div class="detail__dialog detail-box " v-drag-dialog>
            ...
            <div class="detail-body">
                ...
                <div class="detail-item">
                    ...
                    <div class="input-group">
                        <el-tooltip :disabled="isShowTooltip(detailForm.vehicleModelInfoName)" effect="dark" :content="detailForm.vehicleModelInfoName" placement="top">
                ...
                <div class="detail-item">
                    ...
                    <div class="input-group">
                        <span>{{detailForm.timeduration}}</span>
                    </div>
                </div>
                <div class="detail-item">
        ...
        methods: {
            ...
            gpsTrack1(){
                ajax.get('obd/obdAlarmTimeLimit/detail/' + this.id,).then(rs => {
                    ...
                    this.$set(this.detailForm,"mileage",this.detailForm.mileage/1000).toFixed(2);
                    this.gpsTrack2();
                });
            },
            gpsTrack2(){
                ...
                /*划线*/
                ajax.post('obd/obdAlarmTimeLimit/detailMap', this.detailForm).then(rs => {
                    loading.close();
                    if(rs.status == 0){
                        /*划线*/
                        let pointList = [];
